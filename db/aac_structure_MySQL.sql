...
CREATE TABLE IF NOT EXISTS `aac_person` (
  ...
  KEY `Relation_to_BranchOffice01` (`ID_BranchOffice`),
...
CREATE TABLE IF NOT EXISTS `aac_level` (
  ...
  KEY `Relation_to_BranchOffice02` (`ID_BranchOffice`),
...
CREATE TABLE IF NOT EXISTS `aac_classroom` (
  ...
  KEY `Relation_to_BranchOffice03` (`ID_BranchOffice`),
...
DELIMITER //
CREATE DEFINER=`KGRSystems`@`localhost` PROCEDURE `AAC_ListBranchOfficeCBO`()
BEGIN
...
CREATE DEFINER=`KGRSystems`@`localhost` PROCEDURE `AAC_UpdateLevel` (
p_ID_Level NVARCHAR(50),
p_OpenningDate_Level NVARCHAR(100),
p_AcademicGrade_Level NVARCHAR(250),
p_Description_Level NVARCHAR(250),
