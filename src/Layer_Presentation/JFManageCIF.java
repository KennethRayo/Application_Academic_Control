 ...
 * @author KGR
 */
public class JFManageCIF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable_CIF.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "MPago", "Denominacion", "Admision", "Clasificacion", "Moneda"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFManageCIF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFManageCIF().setVisible(true);
            }
        });
    }
