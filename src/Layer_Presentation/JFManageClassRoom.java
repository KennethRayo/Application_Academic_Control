 ...
 * @author KGR
 */
public class JFManageClassRoom extends javax.swing.JFrame {

    /**
     * Creates new form JFTest
     */
    LB_ClassRoom LB = new LB_ClassRoom();
    public JFManageClassRoom() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable_ClassRoom = new javax.swing.JTable();
        ...
        jTable_ClassRoom.setBackground(new java.awt.Color(240, 240, 240));
        jTable_ClassRoom.setForeground(new java.awt.Color(0, 0, 0));
        jTable_ClassRoom.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "ID", "Descripción", "Ubicación", "Capacidad", "Estado"
            }
        ));
        jScrollPane1.setViewportView(jTable_ClassRoom);
    ...
    private void jTextField_SearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_SearchKeyReleased
        // TODO add your handling code here:
        LB.Search(this.jTable_ClassRoom, this.jTextField_Search.getText());
    ...
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UpdateActionPerformed
        ...
        int row = this.jTable_ClassRoom.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_ClassRoom.getSelectedRowCount();

        if (row >=0 && numFS == 1)
        {
            JDClassRoom MD = new JDClassRoom (this, true);
            MD.jTextField_ID.setText(String.valueOf(this.jTable_ClassRoom.getValueAt(row, 0)));
            MD.Actualizar = true;
            MD.ID = String.valueOf(this.jTable_ClassRoom.getValueAt(row, 0));
            //llenar los campos con los datos de la fila seleccionada
            this.jTextField_ID.setText(String.valueOf(this.jTable_ClassRoom.getValueAt(row, 0)));
            MD.jTextField_Description.setText(String.valueOf(this.jTable_ClassRoom.getValueAt(row, 1)));
            MD.jTextField_Location.setText(String.valueOf(this.jTable_ClassRoom.getValueAt(row, 2)));
            MD.jTextField_Capacity.setText(String.valueOf(this.jTable_ClassRoom.getValueAt(row, 3)));
        ...
        {
            JOptionPane.showMessageDialog(null, "Select a row to continue !", "AA Control - ClassRoom", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void jButton_RegistryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistryActionPerformed
        // TODO add your handling code here:
        JDClassRoom viewMANAGEJDCR = new JDClassRoom (this, true);
        viewMANAGEJDCR.jLabel_Code.setText(this.jLabel_Code.getText());
        viewMANAGEJDCR.jLabel_Profile.setText(this.jLabel_Profile.getText());
        this.dispose();
        viewMANAGEJDCR.setVisible(true);
        ListClassRoom();
    ...
    private void jButton_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DeleteActionPerformed
        ...
        int rowDelete = this.jTable_ClassRoom.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_ClassRoom.getSelectedRowCount();
        ...
        {
            String IDD = String.valueOf(this.jTable_ClassRoom.getValueAt(rowDelete, 0));
            LB.setID_ClassRom(IDD);
            int rptaCategory = JOptionPane.showConfirmDialog(null, "Would you like to remove the following ClassRoom ? \n" + IDD);
            ...
            if (rptaCategory == 0)
            {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Removed Unrealized !", "AA Control - ClassRoom", JOptionPane.ERROR_MESSAGE);
                }
            }
            ListClassRoom();
        }
        else
        {
            JOptionPane.showMessageDialog(null, "Select one row to remove ! \n\n" +
                "Once removed AA Control may not get it back", "AA Control - ClassRoom", JOptionPane.WARNING_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFManageClassRoom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFManageClassRoom().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTable_ClassRoom;
