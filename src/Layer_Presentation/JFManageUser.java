 ...
 * @author KGR
 */
public class JFManageUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel_SidebarLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_SidebarLayout.createSequentialGroup()
                .addGroup(jPanel_SidebarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel_SidebarLayout.createSequentialGroup()
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jLabel_Close)))
                .addGap(18, 18, 18))
        );

        getContentPane().add(jPanel_Sidebar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1170, 40));
        ...
        jTable_User.setBackground(new java.awt.Color(240, 240, 240));
        jTable_User.setForeground(new java.awt.Color(0, 0, 0));
        jTable_User.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Pass", "Email", "Name", "Profile", "Status"
            }
        ));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 38, 1170, 400));
    ...
    private void jLabel_CloseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_CloseMouseClicked
        ...
        JFUser_Principal viewR = new JFUser_Principal();
    ...
    private void jTextField_SearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_SearchKeyReleased
        // TODO add your handling code here:
        LB.SearchUser(this.jTable_User, this.jTextField_Search.getText());
    ...
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UpdateActionPerformed
        ...
        int row = this.jTable_User.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_User.getSelectedRowCount();

        if (row >=0 && numFS == 1)
        {
            JDUser MD = new JDUser (this, true);
            MD.Actualizar = true;
            //MD.jPanel_Background.setVisible(false);
            MD.ID = String.valueOf(this.jTable_User.getValueAt(row, 0));
            //llenar los campos con los datos de la fila seleccionada
            this.jTextField_ID.setText(String.valueOf(this.jTable_User.getValueAt(row, 0)));
        ...
        {
            JOptionPane.showMessageDialog(null, "Select a row to continue !", "AA Control - User", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void jButton_RrgistryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RrgistryActionPerformed
        // TODO add your handling code here:
        JDUser viewMANAGEUAD = new JDUser (this, true);
    ...
    private void jButton_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DeleteActionPerformed
        ...
        int rowDelete = this.jTable_User.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_User.getSelectedRowCount();
        ...
        {
            String IDD = String.valueOf(this.jTable_User.getValueAt(rowDelete, 0));
            LB.setID_Person(IDD);
            int rptaCategory = JOptionPane.showConfirmDialog(null, "Would you like to remove the following User ? \n" + IDD);
        ...
        else
        {
            JOptionPane.showMessageDialog(null, "Select one row to remove ! \n\n" +
                "Once removed AA Control may not get it back", "AA Control - User", JOptionPane.WARNING_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFManageUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFManageUser().setVisible(true);
            }
        });
    }
