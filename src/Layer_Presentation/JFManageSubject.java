 ...
 * @author KGR
 */
public class JFManageSubject extends javax.swing.JFrame {

    /**
     * Creates new form JFTest
     */
    LB_Subject LB = new LB_Subject();
    public JFManageSubject() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable_Subject.setBackground(new java.awt.Color(240, 240, 240));
        jTable_Subject.setForeground(new java.awt.Color(0, 0, 0));
        jTable_Subject.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nivel", "Créditos", "Fecha Apertura", "Descripción", "Periodo", "Nota Mínima", "Horas Duración", "Nota Mínima Ext", "Cupo Mínimo", "Moneda", "Estado"
            }
        ));
    ...
    private void jTextField_SearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_SearchKeyReleased
        // TODO add your handling code here:
        LB.Search(this.jTable_Subject, this.jTextField_Search.getText());
    ...
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UpdateActionPerformed
        ...
        int row = this.jTable_Subject.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_Subject.getSelectedRowCount();

        if (row >=0 && numFS == 1)
        {
            JDSubject MD = new JDSubject (this, true);
            MD.jTextField_IDSubject.setText(String.valueOf(this.jTable_Subject.getValueAt(row, 0)));
            MD.Actualizar = true;
            MD.ID = String.valueOf(this.jTable_Subject.getValueAt(row, 0));
            //llenar los campos con los datos de la fila seleccionada
            this.jTextField_ID.setText(String.valueOf(this.jTable_Subject.getValueAt(row, 0)));
            MD.jSpinner_Credits.setValue(Integer.parseInt(String.valueOf(this.jTable_Subject.getValueAt(row, 2))));
            MD.jDateChooser_OpeningDate.setDate(Date.valueOf(String.valueOf(this.jTable_Subject.getValueAt(row, 3))));
            MD.jTextField_Description.setText(String.valueOf(this.jTable_Subject.getValueAt(row, 4)));
            MD.jSpinner_MinimunNote.setValue(Integer.parseInt(String.valueOf(this.jTable_Subject.getValueAt(row, 6))));
            MD.jSpinner_HoursDuration.setValue(Integer.parseInt(String.valueOf(this.jTable_Subject.getValueAt(row, 7))));
            MD.jSpinner_ExtraordinayMinimunNote.setValue(Integer.parseInt(String.valueOf(this.jTable_Subject.getValueAt(row, 8))));
            MD.jSpinner_MinimunQuote.setValue(Integer.parseInt(String.valueOf(this.jTable_Subject.getValueAt(row, 9))));
    ...
    private void jButton_RegistryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistryActionPerformed
        // TODO add your handling code here:
        JDSubject viewMANAGEJDSubject = new JDSubject (this, true);
        viewMANAGEJDSubject.jLabel_Code.setText(this.jLabel_Code.getText());
        viewMANAGEJDSubject.jLabel_Profile.setText(this.jLabel_Profile.getText());
        this.dispose();
        viewMANAGEJDSubject.setVisible(true);
        ListSubject();
    ...
    private void jButton_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DeleteActionPerformed
        ...
        int rowDelete = this.jTable_Subject.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_Subject.getSelectedRowCount();
        ...
        {
            String IDD = String.valueOf(this.jTable_Subject.getValueAt(rowDelete, 0));
            LB.setID_Subject(IDD);
            int rptaCategory = JOptionPane.showConfirmDialog(null, "Would you like to remove the following Subject ? \n" + IDD);
            ...
            if (rptaCategory == 0)
            {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Removed Unrealized !", "AA Control - Subject", JOptionPane.ERROR_MESSAGE);
                }
            }
            ListSubject();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFManageSubject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFManageSubject().setVisible(true);
            }
        });
    }
