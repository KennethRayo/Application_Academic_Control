 ...
 * @author KGR
 */
public class JFManageStatistics_UAD extends javax.swing.JFrame {
    ...
    public void ListALL()
    {
        ...
        switch(op){
            case 0:
                miModelo = LB.Statistics_GenderPerson_UAD();
                tblConsultas.setModel(miModelo);
                GraphALL();
            break;
            case 1:
                miModelo = LB.Statistics_CountryPerson_UAD();
                tblConsultas.setModel(miModelo);
                GraphALL();
            break;
            case 2:
                miModelo = LB.Statistics_ProvincePerson_UAD();
                tblConsultas.setModel(miModelo);
                GraphALL();
            break;
            case 3:
                miModelo = LB.Statistics_DistrictPerson_UAD();
                tblConsultas.setModel(miModelo);
                GraphALL();
            break;
            case 4:
                miModelo = LB.Statistics_CantonPerson_UAD();
                tblConsultas.setModel(miModelo);
                GraphALL();
            break;
            case 5:
                miModelo = LB.Statistics_CivilStatusPerson_UAD();
                tblConsultas.setModel(miModelo);
                GraphALL();
            break;
    ...
    public void ListBO()
    {
        ...
        switch(op){
            case 0:
                miModelo = LB.Statistics_GenderPerson_BO_UAD(idBO);
                tblConsultas.setModel(miModelo);
                GraphALL();
            break;
            case 1:
                miModelo = LB.Statistics_CountryPerson_BO_UAD(idBO);
                tblConsultas.setModel(miModelo);
                GraphALL();
            break;
            case 2:
                miModelo = LB.Statistics_ProvincePerson_BO_UAD(idBO);
                tblConsultas.setModel(miModelo);
                GraphALL();
            break;
            case 3:
                miModelo = LB.Statistics_DistrictPerson_BO_UAD(idBO);
                tblConsultas.setModel(miModelo);
                GraphALL();
            break;
            case 4:
                miModelo = LB.Statistics_CantonPerson_BO_UAD(idBO);
                tblConsultas.setModel(miModelo);
                GraphALL();
            break;
            case 5:
                miModelo = LB.Statistics_CivilStatusPerson_BO_UAD(idBO);
                tblConsultas.setModel(miModelo);
                GraphALL();
            break;
            default: JOptionPane.showMessageDialog(null, "Checking.. the Option !", "AA Control - Statistics UAD", JOptionPane.WARNING_MESSAGE);
    ...
    public void GraphALL()
    {
        if(jRadioButton_3D.isSelected() && jRadioButton_Circular.isSelected()){
            ...
            JFreeChart ch = ChartFactory.createPieChart3D("Estadística UAD", dtsc,true, true, false);
        ...
        if(jRadioButton_2D.isSelected() && jRadioButton_Circular.isSelected()){
            ...
            JFreeChart ch = ChartFactory.createPieChart("Estadística UAD", dtsc,true, true, false);
            ChartPanel cp = new ChartPanel(ch);
            add(cp);
            cp.setBounds(500,40,500,400);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ESTADÍSTICA UAD");
        ...
        jComboBox_Option.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Género", "País", "Provincia", "Distrito", "Canton", "Estado Civil" }));
        ...
        jComboBox_OptionB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Género", "País", "Provincia", "Distrito", "Canton", "Estado Civil" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFManageStatistics_UAD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFManageStatistics_UAD().setVisible(true);
            }
        });
    }
