 ...
 * @author KGR
 */
public class JFManageCareer extends javax.swing.JFrame {

    /**
     * Creates new form JFTest
     */
    LB_Career LB = new LB_Career();
    public JFManageCareer() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable_Career = new javax.swing.JTable();
        ...
        jTable_Career.setBackground(new java.awt.Color(240, 240, 240));
        jTable_Career.setForeground(new java.awt.Color(0, 0, 0));
        jTable_Career.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "ID", "Descripción", "Director", "Apertura", "Estado"
            }
        ));
        jScrollPane1.setViewportView(jTable_Career);
    ...
    private void jTextField_SearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_SearchKeyReleased
        // TODO add your handling code here:
        LB.Search(this.jTable_Career, this.jTextField_Search.getText());
    ...
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UpdateActionPerformed
        ...
        int row = this.jTable_Career.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_Career.getSelectedRowCount();

        if (row >=0 && numFS == 1)
        {
            JDCareer MD = new JDCareer (this, true);
            //MD.jPanel_OpeningDate.setVisible(false);
            
            MD.Actualizar = true;
            MD.ID = String.valueOf(this.jTable_Career.getValueAt(row, 0));
            //llenar los campos con los datos de la fila seleccionada
            this.jTextField_ID.setText(String.valueOf(this.jTable_Career.getValueAt(row, 0)));
            MD.jTextField_ID.setText(String.valueOf(this.jTable_Career.getValueAt(row, 0)));
            MD.jTextField_Description.setText(String.valueOf(this.jTable_Career.getValueAt(row, 1)));
            MD.jDateChooser_OpeningDate.setDate(Date.valueOf(String.valueOf(this.jTable_Career.getValueAt(row, 3))));
            MD.jTextField_ID.setEditable(false);
        ...
        {
            JOptionPane.showMessageDialog(null, "Select a row to continue !", "AA Control - Career", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void jButton_RegistryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistryActionPerformed
        // TODO add your handling code here:
        JDCareer viewMANAGEJDCareer = new JDCareer (this, true);
        viewMANAGEJDCareer.jLabel_Code.setText(this.jLabel_Code.getText());
        viewMANAGEJDCareer.jLabel_Profile.setText(this.jLabel_Profile.getText());
        viewMANAGEJDCareer.jPanel_OpeningDate.setVisible(true);
        this.dispose();
        viewMANAGEJDCareer.setVisible(true);
        ListCIF();
    ...
    private void jButton_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DeleteActionPerformed
        ...
        int rowDelete = this.jTable_Career.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_Career.getSelectedRowCount();
        ...
        {
            String IDD = String.valueOf(this.jTable_Career.getValueAt(rowDelete, 0));
            LB.setID_Career(IDD);
            int rptaCategory = JOptionPane.showConfirmDialog(null, "Would you like to remove the following Career ? \n" + IDD);
            ...
            if (rptaCategory == 0)
            {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Removed Unrealized !", "AA Control - Career", JOptionPane.ERROR_MESSAGE);
                }
            }
            ListCIF();
        }
        else
        {
            JOptionPane.showMessageDialog(null, "Select one row to remove ! \n\n" +
                "Once removed AA Control may not get it back", "AA Control - Career", JOptionPane.WARNING_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFManageCareer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFManageCareer().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTable_Career;
