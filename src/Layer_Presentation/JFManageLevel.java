 ...
 * @author KGR
 */
public class JFManageLevel extends javax.swing.JFrame {

    /**
     * Creates new form JFTest
     */
    LB_Level LB = new LB_Level();
    public JFManageLevel() {
        initComponents();
        setLocationRelativeTo(null);
        ListLavel();
    }

    public void ListLavel()
    {
        LB.List(this.jTable_Lavel);
    }
    /**
    ...
    private void initComponents() {
        ...
        jTable_Lavel = new javax.swing.JTable();
        ...
        jTable_Lavel.setBackground(new java.awt.Color(240, 240, 240));
        jTable_Lavel.setForeground(new java.awt.Color(0, 0, 0));
        jTable_Lavel.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "ID", "Carrera", "Fecha Apertura", "Grado Académico", "Descripción", "Director", "Énfasis", "Créditos", "Nota Mínima", "Estado"
            }
        ));
        jScrollPane1.setViewportView(jTable_Lavel);
    ...
    private void jLabel_CloseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_CloseMouseClicked
        ...
        JFBasic_Principal viewR = new JFBasic_Principal();
    ...
    private void jTextField_SearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_SearchKeyReleased
        // TODO add your handling code here:
        LB.Search(this.jTable_Lavel, this.jTextField_Search.getText());
    ...
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UpdateActionPerformed
        ...
        int row = this.jTable_Lavel.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_Lavel.getSelectedRowCount();

        if (row >=0 && numFS == 1)
        {
            JDLevel MD = new JDLevel (this, true);
            //MD.jPanel_OpeningDate.setVisible(false);
            
            MD.Actualizar = true;
            MD.ID = String.valueOf(this.jTable_Lavel.getValueAt(row, 0));
            //llenar los campos con los datos de la fila seleccionada
            this.jTextField_ID.setText(String.valueOf(this.jTable_Lavel.getValueAt(row, 0)));
            MD.jTextField_IDLevel.setText(String.valueOf(this.jTable_Lavel.getValueAt(row, 0)));
            MD.jDateChooser_OpeningDate.setDate(Date.valueOf(String.valueOf(this.jTable_Lavel.getValueAt(row, 2))));
            MD.jTextField_AcademicGrade.setText(String.valueOf(this.jTable_Lavel.getValueAt(row, 3)));
            MD.jTextField_Description.setText(String.valueOf(this.jTable_Lavel.getValueAt(row, 4)));
            MD.jTextField_Enphatic.setText(String.valueOf(this.jTable_Lavel.getValueAt(row, 6)));
            MD.jSpinner_Credits.setValue(Integer.parseInt(String.valueOf(this.jTable_Lavel.getValueAt(row, 7))));
            MD.jSpinner_MinimunNote.setValue(Integer.parseInt(String.valueOf(this.jTable_Lavel.getValueAt(row, 8))));
            MD.jTextField_IDLevel.setEditable(false);
        ...
        {
            JOptionPane.showMessageDialog(null, "Select a row to continue !", "AA Control - Level", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void jButton_RegistryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistryActionPerformed
        // TODO add your handling code here:
        JDLevel viewMANAGEJDLavel = new JDLevel (this, true);
        viewMANAGEJDLavel.jLabel_Code.setText(this.jLabel_Code.getText());
        viewMANAGEJDLavel.jLabel_Profile.setText(this.jLabel_Profile.getText());
        this.dispose();
        viewMANAGEJDLavel.setVisible(true);
        ListLavel();
    ...
    private void jButton_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DeleteActionPerformed
        ...
        int rowDelete = this.jTable_Lavel.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_Lavel.getSelectedRowCount();
        ...
        {
            String IDD = String.valueOf(this.jTable_Lavel.getValueAt(rowDelete, 0));
            LB.setID_Level(IDD);
            int rptaCategory = JOptionPane.showConfirmDialog(null, "Would you like to remove the following Level ? \n" + IDD);
            ...
            if (rptaCategory == 0)
            {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Removed Unrealized !", "AA Control - Level", JOptionPane.ERROR_MESSAGE);
                }
            }
            ListLavel();
        }
        else
        {
            JOptionPane.showMessageDialog(null, "Select one row to remove ! \n\n" +
                "Once removed AA Control may not get it back", "AA Control - Level", JOptionPane.WARNING_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFManageLevel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFManageLevel().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTable_Lavel;
